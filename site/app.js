...
const I18N = {
  en: {
    ...
    lang_zh: "中文",
    lang_en: "English",
    value_pill_1: "Daily email alerts",
    ...
    subscribe_title: "Daily Email Subscription",
    subscribe_text: "Enter your email to receive one daily update email.",
  ...
  zh: {
    ...
    subscribe_title: "每日邮件订阅",
    subscribe_text: "输入邮箱后，每天接收一封更新邮件。",
    subscribe_placeholder: "you@example.com",
    subscribe_button: "订阅",
